...
def transform_raw_data(from_table_name, to_table_name):
    ...
    for row in raw_data:
        image_tags = row[21].split("]")[1].strip("'").split("''")
        ...
        print(insert_sql % (to_table_name, row[0], row[1], row[2], row[4], row[5], row[6], row[7], row[8],
                                        row[9], row[10], row[11], row[12], row[13], row[14], row[15], row[16], row[17],
                                        row[18], image_tags, "NULL", "NULL", "NULL", "NULL", "NULL", "NULL",
...
transform_raw_data("kylin", "kylin_raw_data")
transform_raw_data("qingdao", "qingdao_raw_data")
transform_raw_data("snow", "snow_raw_data")
transform_raw_data("panda", "panda_raw_data")
